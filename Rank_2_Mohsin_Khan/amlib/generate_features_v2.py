    ...
    return make_pipeline(
        make_union(
            ...
            make_pipeline(
                make_union(
                    VectorMapper(
                        col=FieldNames.coupon_id, vector_file=FileNames.coupon_vectors
                    ),
                    HistVectorMean(
...
def get_feature_names(hist_n):
    ...
    cols10 = [
        "customer_campaign_count",
        "customer_coupon_count_all",
        "unq_item_hist1",
        "unq_item_hist2",
        "unq_item_hist3",
        "coupon_item_similarity",
    ]
    feats_base = (
...
def generate_features(flag):
    if flag == "test":
        ...
        tr_save_file = FileNames.train_features_v2
        te_save_file = FileNames.test_features_v2
    elif flag == "val":
        ...
        tr_save_file = FileNames.tr_features_v2
        te_save_file = FileNames.val_features_v2
    else:
        print("flag not VALD!")
