...
def generate_features(flag):
    if flag == "test":
        ...
        tr_save_file = FileNames.train_features_v3
        te_save_file = FileNames.test_features_v3
    elif flag == "val":
        ...
        tr_save_file = FileNames.tr_features_v3
        te_save_file = FileNames.val_features_v3
    else:
        print("flag not VALD!")
